        ...
        <div id="right_content">
            ...
            <div id="main_resources_box">
                <div id="sub_aboutus" style="text-align:center;">
                    ...
                    <p style="padding:0px 10px 3px; text-align:left;"><a href="agusandelsurresourcesfullarticle.php?resource_id=1" class="link_3">Venus Raj, newest ambassador for UN Philippines campaign</a></p>
