...
<div id="outer">
    ...
    <div id="site_content_1">
        ...
        <div id="right_content">
            <p class="text_6" style="padding:20px 0px;">My Report</p>
            <div id="aboutus">
                <div id="maincontactus_box">
                    <div id="maincontactus_text" class="text_16">Username:</div>
                    <div id="maincontactus_input"><input type="text" id="user_name_id" name="user_name" class="input_1" style="width:250px;" /></div>
                </div>
                <div id="maincontactus_box">
                    <div id="maincontactus_text" class="text_16">Mobile:</div>
