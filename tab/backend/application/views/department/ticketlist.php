  ...
  <tr>
    <td colspan="7">
    	<div style="padding:10px 0px;">
            ...
            <input type="button" id="btn_closed_id" name="btn_closed" class="btn_1" value="Closed" style="width:100px;" onclick="tabToggle(3.5);" />&nbsp; 
...
<table width='100%' border="0" cellspacing="0" cellpadding="0" id="parameter_2" style="display:none;">
  ...
  <?php
	  ...
	  <tr bgcolor="<?php echo $row_color; ?>" <?php echo $style; ?>>
		...
		<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo word_limit(nl2br(urldecode(stripslashesx($r['description']))), 20); ?><br>
		<a href="#" onclick="openThreadDialog('<?php echo $r['id']; ?>');" class="link_3">Edit Report</a></div></td>
		<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo $r['name']; ?>&nbsp;</div></td>
  	...
  	foreach($responded_tickets as $k=>$r){
		...
		//2012-03-13 11:17:55
		  ...
		  <tr bgcolor="<?php echo $row_color; ?>" <?php echo $style; ?>>
			...
			<td class="text_1" style="border-bottom:1px solid #CCC;"><div style="padding:10px;"><? echo $r['department']; ?></div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo word_limit(nl2br(urldecode(stripslashesx($r['description']))), 20); ?><br>
			<a href="#" onclick="openThreadDialog('<?php echo $r['id']; ?>');" class="link_3">Re-open / Close Report</a></div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo $r['name']; ?>&nbsp;</div></td>
			<td style="border-bottom:1px solid #CCC;"><div style="padding:10px;"><?php if($r['number']) echo $r['number']; else echo $r['email']; ?>&nbsp;</div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo $r['barangay']; ?></div></td>
		  </tr>
...
<table width='100%' border="0" cellspacing="0" cellpadding="0" id="parameter_3_5" style="display:none;">
  <tr class="pagination">
    <td class="text_1" colspan="8"><div style="padding:5px;"><hr /></div></td>
  </tr>
  <tr class="pagination">
  	...
  	foreach($closed_tickets as $k=>$r){
		...
		//2012-03-13 11:17:55
		  ...
		  <tr bgcolor="<?php echo $row_color; ?>" <?php echo $style;?> >
			...
			<td class="text_1" style="border-bottom:1px solid #CCC;"><div style="padding:10px;"><? echo $r['department']; ?></div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo word_limit(nl2br(urldecode(stripslashesx($r['description']))), 20); ?><br>
			<a href="#" onclick="openThreadDialog('<?php echo $r['id']; ?>');" class="link_3">View Ticket</a></div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo $r['name']; ?>&nbsp;</div></td>
			<td style="border-bottom:1px solid #CCC;"><div style="padding:10px;"><?php if($r['number']) echo $r['number']; else echo $r['email']; ?>&nbsp;</div></td>
			<td style="border-bottom:1px solid #CCC;" class="text_1"><div style="padding:10px;"><?php echo $r['barangay']; ?></div></td>
		  </tr>
