    ...
    <div id="site_content_1">
        ...
        <div id="right_content">
        	<div id="sub_content_1">
            	<div id="sub_aboutus" class="text_7">
                	<p class="text_14" style="padding-bottom:10px;"><b>Tingog</b> is a Citizens' Feedback Platform </p>
                    <p style="padding-bottom:10px;">that aims to ensure service delivery, especially in the achievement of the Millennium Development Goals (MDG) at the grassroots, by allowing citizens to report on, monitor, and send feedback on government services through the use of SMS and the Internet.</p>
                ...
                <div id="sub_message">
                	<div id="sub_bg_message">
                    	<div id="sub_bg_message_header" class="text_8">MAYOR'S MESSAGE</div>
                        <div id="sub_message_content">
                        	<div id="sub_message_img">
                            	<div id="sub_message_img_border">
                                	<table width="100%" height="154" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td align="center"><img src="images/sub/pic_mayor_tabaco.jpg" width="155" height="154" border="0" alt="Mayor's Message" title="Mayor's Message" /></td>
                                      </tr>
                                    </table>
                                </div>
                            </div>
                            <div class="text_7">
                            	<p style="padding-bottom:10px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas luctus elementum venenatis. Morbi ipsum magna, porta eu lacinia id, cursus laoreet metus. Praesent ut orci eu sapien pellentesque facilisis.</p>
                                <p>Morbi ipsum magna, porta eu</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="sub_content_1">
            	<div id="sub_aboutus">
                	<p class="text_8" style="color:#cd0000; padding-bottom:10px;">HOW TO ISSUE A REPORT</p>
                    <p class="text_7">You can now evaluate the quality of government service delivery in your community. Speak out and make your voice heard by reporting a concern or sending feedback.</p>
                </div>
            	<div id="sub_message">
                	<div id="sub_bg_currentissues_2" class="text_7">
                    	<table width="238" height="51" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td>
                            	<p class="text_15" style="padding-bottom:5px;"><b>CURRENT ISSUES</b></p>
                                <p>1 - Child Health</p>
                                <p>2 - Maternal Health</p>
                            </td>
                          </tr>
                        </table>
                    </div>
            ...
            <div id="sub_content_1">
            	<div id="sub_aboutus">
                	<div id="sub_howtoissue_box">
                    	<div id="sub_howtoissue_bg_header" class="text_8">VIA SMS</div>
                        <div id="sub_howtoissue_img"><img src="images/sub/howtoissue_cellphone_tab.png" width="118" height="211" border="0" alt="HOW TO ISSUE A REPORT" title="HOW TO ISSUE A REPORT" /></div>
                        <div id="sub_howtoissue_text">
                        	<p class="text_7" style="padding:0px 0px 10px 15px;">Text <span class="text_10">TINGOG TAB/ &lt;BARANGAY&gt;/ &lt;REPORT&gt;</span> and send to 2015.</p>
                            ...
                            <p class="text_11" style="padding:0px 0px 10px 15px;">*SMS are subject to P1 charging</p>
                            <p class="text_11" style="padding-left:15px;">You will receive an <u>auto-acknowledgment</u> once your message is received by the system.</p>
                        </div>
                    </div>
                </div>
            	<div id="sub_message">
                	<div id="sub_howtoissue_box">
                    	<div id="sub_howtoissue_bg_header" class="text_8">VIA WEB</div>
                        <div id="sub_howtoissue_img">
                        	<table width="100%" height="211" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><img src="images/sub/howtoissue_hand.png" width="139" height="139" border="0" alt="HOW TO ISSUE A REPORT" title="HOW TO ISSUE A REPORT" /></td>
                              </tr>
                            </table>
                        </div>
                        <div id="sub_howtoissue_text">
                        	<p class="text_7" style="padding-bottom:20px;">Click on the <b>SUBMIT REPORT</b> button and complete the online form.</p>
                            <p style="text-align:center; padding-bottom:10px;"><a href="submitreport.php"><img src="images/buttons/sub/submitreport.png" width="122" height="33" border="0" alt="Submit Report" title="Submit Report" /></a></p>
                            <p style="text-align:center;"><a href="myreports.php"><img src="images/buttons/sub/trackreport.png" width="122" height="33" border="0" alt="Track Report" title="Track Report" /></a></p>
                        </div>
                    </div>
                </div>
            </div>
        	<div id="index_issuemaptracking" style="border-bottom:6px solid #bdbdbd;">
            	<div id="index_howtoissue_title" class="text_8" style="background-color:#FFF; color:#cd0000;">ISSUE TRACKING MAP</div>
                ...
                <div id="index_issuemaptracking_btn"><a href="submitreport.php"><img src="images/buttons/index_submit_report.jpg" width="122" height="33" border="0" alt="Submit Report" title="Submit Report" /></a> <a href="myreports.php"><img src="images/buttons/index_track_report.jpg" width="145" height="33" border="0" alt="Track My Report" title="Track My Report" /></a></div>
            </div>
            <div id="index_news">
            	<div id="index_newsandresources_title" class="text_8" style="background-color:#FFF; color:#cd0000;">NEWS</div>
                <div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=1" class="link_1">Venus Raj speaks out for poor children, MDGs</a></p>
                ...
                <div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=2" class="link_1">Venus Raj, newest ambassador for UN Philippines campaign </a></p>
                ...
                <div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=3" class="link_1">Your voice can now be heard </a></p>
                ...
                <!--<div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=4" class="link_1">Venus Raj is spokesperson for UN program</a></p>
                ...
                <div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=5" class="link_1">Bicol town taps online, SMS tools for feedback</a></p>
                ...
                <div id="index_news_article">
                	<p><a href="mainnewsfullarticle.php?news_id=6" class="link_1">Venus Raj Newest Ambassador for UN Philippines TINGOG 2015 Campaign</a></p>
            ...
            <div id="index_resources">
            	<div id="index_newsandresources_title" class="text_8" style="background-color:#FFF; color:#cd0000;">RESOURCES</div>
