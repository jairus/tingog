...
<div id="outer">
    ...
    <div id="site_content_1">
        ...
        <div id="right_content">
			...
			<div id='message' class="text_4"></div><br />
            ...
            <div id="aboutus">
                ...
                <div id="maincontactus_box">
                    ...
                    <div id="maincontactus_input">
                      <input type="text" id="mobile_num_id" name="mobile_num" class="input_1" style="width:250px;" />
                    </div>
                </div>
                <div id="maincontactus_box" style="text-align:right; padding-right:260px; width:473px;"><input type="button" id="btn_send_id" name="btn_send" value="Send" class="btn_2" style="width:100px;" onclick="submitReport();" /></div>
            </div>
			</form>
        </div>
    </div>
