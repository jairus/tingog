	...
	function submitReport(){
		jQuery.ajax({
			...
			success: function(message){
				...
				if(message=='Thank you for submitting your report.'){
					jQuery("#createticket_form_id")[0].reset();
				}
			},
		});
        ...
        <div id="right_content">
            ...
            <div id="aboutus">
                ...
                <div id="maincontactus_box">
                    ...
                    <div id="maincontactus_input"><input type="text" id="barangay_id" name="location" class="input_1" style="width:250px;" />
                    </div>
                </div>
                <div id="maincontactus_box">
                    <div id="maincontactus_text" class="text_16">Email:</div>
                    <div id="maincontactus_input"><input type="text" id="mobile_num_id" name="email" class="input_1" style="width:250px;" />
                    </div>
                </div>
                <div id="maincontactus_box">
                    <div id="maincontactus_text" class="text_16">Mobile No.:</div>
                    <div id="maincontactus_input"><input type="text" id="mobile_num_id" name="contactnumber" class="input_1" style="width:250px;" />
                    </div>
                </div>
                <div id="maincontactus_box">
                    <div id="maincontactus_text" class="text_16">Report:</div>
                    <div id="maincontactus_input"><textarea id="report_id" name="description" class="input_1" style="width:250px; height:100px;"></textarea>
                    </div>
                </div>
                <div id="maincontactus_box" style="text-align:right; padding-right:260px; width:473px;"><input type="button" id="btn_send" name="btn_send" value="Send" class="btn_2" style="width:100px;" onclick="submitReport();" /></div>
            </div>
			</form>
        </div>
    </div>
